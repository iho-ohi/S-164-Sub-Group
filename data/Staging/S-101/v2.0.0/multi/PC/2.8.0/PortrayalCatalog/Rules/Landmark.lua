...
function Landmark(feature, featurePortrayal, contextParameters)
	...
	if feature.PrimitiveType == PrimitiveType.Point and contextParameters.SimplifiedSymbols then
		...
		elseif contains(30, feature.categoryOfLandmark) and contains(20, feature['function']) and feature.visualProminence == 1 then
			featurePortrayal:AddInstructions('PointInstruction:BUIREL13')
		elseif contains(30, feature.categoryOfLandmark) and contains(21, feature['function']) and feature.visualProminence == 1 then
			featurePortrayal:AddInstructions('PointInstruction:BUIREL13')
		elseif contains(30, feature.categoryOfLandmark) and contains(26, feature['function']) and feature.visualProminence == 1 then
			featurePortrayal:AddInstructions('PointInstruction:BUIREL15')
		elseif contains(30, feature.categoryOfLandmark) and contains(27, feature['function']) and feature.visualProminence == 1 then
			featurePortrayal:AddInstructions('PointInstruction:BUIREL15')
		...
		elseif contains(30, feature.categoryOfLandmark) and feature.visualProminence == 1 then
			featurePortrayal:AddInstructions('PointInstruction:POSGEN03')
		...
		elseif contains(30, feature.categoryOfLandmark) and contains(20, feature['function']) then
			featurePortrayal:AddInstructions('PointInstruction:BUIREL01')
		...
		elseif contains(30, feature.categoryOfLandmark) then
